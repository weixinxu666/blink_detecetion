...
# ap.add_argument("-p", "shape_predictor_68_face_landmarks.dat", required=True, help="path to facial landmark predictor")
...
while True:
	...
	for rect in rects:
		...
		# print(type(int(leftEyeHull[0][0][1])))
		x = int(leftEyeHull[0][0][0])
		y = int(leftEyeHull[0][0][1])
		cv2.drawContours(frame, [leftEyeHull], -1, (0, 0, 255), 1)
		# cv2.circle(frame,leftEyeHull,3,(0.255,0))
		...
		# threshold
			...
			if LEFTCOUNTER >= EYE_AR_CONSEC_FRAMES and RIGHTCOUNTER >= EYE_AR_CONSEC_FRAMES:
				BOTH += 1
				# x,y = m.position()
				# m.move(leftEyeHull[0][0],leftEyeHull[0][1])
				# m.click(x,y,1)
